...
public void setRecord() {
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT staff_id, firstname, surname, date, SUM(totalSales) AS totalSales FROM salesrecord GROUP BY staff_id, firstname, surname, date");
    ...
    private void initComponents() {
        ...
        jLabel7.setText("SALES PEOPLE RECORDS");
