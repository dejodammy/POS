 ...
 * @author Damilola
 */
public class allStaffs extends javax.swing.JFrame {
        ...
        initComponents();
         setImages();
           try{
            ...
            ResultSet rs = st.executeQuery("SELECT staff_id, firstname, surname, date_of_birth, phone_number, email, gender, role, username  FROM staff");
